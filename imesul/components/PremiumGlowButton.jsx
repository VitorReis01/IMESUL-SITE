...
export default function PremiumGlowButton({
  ...
  return (
    <a
      ...
      className={`group/glow relative isolate overflow-hidden focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${focusOutline} hover:-translate-y-0.5 ${className}`}
      {...anchorProps}
    >
      <span
        aria-hidden="true"
