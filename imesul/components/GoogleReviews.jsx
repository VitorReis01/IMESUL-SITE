...
export default function GoogleReviews() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#050b14] py-24 lg:py-28">
      ...
      <div data-mobile-gradient="bottom" aria-hidden="true" className="pointer-events-none absolute inset-x-0 bottom-0 z-[2] h-36 bg-gradient-to-b from-transparent via-[#050b14]/72 to-[#050b14] lg:hidden" />
