...
export const catalogSpecifications = {
  ...
  laminados: {
    ...
    barrasChatas: buildSpecs(
      ...
      { paginaFonte: 7, unidadeMedida: "polegadas", observacao: "A última linha repetida como 3/8 no PDF foi omitida por ambiguidade. Cinco combinacoes de barra chata foram adicionadas a partir do levantamento fisico, sem peso informado." }
    ),
