...
// Redireciona rotas inexistentes para o inicio do atendimento comercial.
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#06101d] px-6 text-center text-white">
      <div className="max-w-lg">
        ...
        <h1 className="mt-4 font-display text-6xl leading-none">Essa página não foi encontrada.</h1>
        <p className="mt-5 text-imesul-steel-light/80">Volte para o início da Área de Vendas.</p>
